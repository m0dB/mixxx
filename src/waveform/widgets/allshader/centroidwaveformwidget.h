...
namespace allshader {
class CentroidWaveformWidget;
}

class allshader::CentroidWaveformWidget final : public allshader::WaveformWidget {
    Q_OBJECT
  public:
    WaveformWidgetType::Type getType() const override {
        return WaveformWidgetType::AllShaderCentroidWaveform;
    }
  ...
  private:
    CentroidWaveformWidget(const QString& group, QWidget* parent);
    friend class ::WaveformWidgetFactory;

    DISALLOW_COPY_AND_ASSIGN(CentroidWaveformWidget);
};
